...
\begin{itemize}
  ...
  \item \textbf{\textsc{Removal}:} corresponde al proceso \textsc{Removal} aplicado sobre el modelo base en la columna \textit{Base} 
      y sobre el modelo más simple obtenido luego de aplicar ambas simplificaciónes en la columna \textit{SMT}.
\end{itemize}
